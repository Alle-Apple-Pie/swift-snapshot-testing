...
extension Snapshotting where Value == CALayer, Format == NSImage {
  ...
  public static func image(precision: Float, perceptualPrecision: Float = 0.98) -> Snapshotting {
...
extension Snapshotting where Value == CALayer, Format == UIImage {
  ...
  public static func image(precision: Float = 1, perceptualPrecision: Float = 0.98, traits: UITraitCollection = .init())
    -> Snapshotting {
